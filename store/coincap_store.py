...
crypto_sheet.write('G1', 'Date Change')
...
for x in range(1,10):
	...
	for currency in data:
		...
		crypto_sheet.write(f,2,market_cap)
		crypto_sheet.write(f,3,price)
		crypto_sheet.write(f,4,volume)
		crypto_sheet.write(f,5,hour_change)
		crypto_sheet.write(f,6,day_change)
		crypto_sheet.write(f,7,week_change)
